...
TEST(TimestampTest, Basic) {
  ...
  // FromUnixTime functions incorrectly accepted the last second of 1399 as valid,
  // because validation logic checked the nearest second rounded towards 0. (IMPALA-5664)
  ...
  // checking subsecond FromUnixTineFunctions near 10000.01.01
